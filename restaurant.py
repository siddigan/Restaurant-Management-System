...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Siddigan TM",bd=2,relief=SUNKEN)
...
txtreference = Entry(f1,font=('ariel' ,16,'bold'), textvariable=rand , bd=6,insertwidth=4,bg="powder blue" ,justify='right',state='disabled')
